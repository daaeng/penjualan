    ...
    <>
      <div className={`ml-24 mb-4 flex-wrap w-full`}>
        ...
        <div className='grid lg:grid-cols-4 gap-4 p-4  '>
            ...
            <div className='lg:col-span-2  flex justify-between w-full  p-4 rounded-lg bg-gray-300 '>
        ...
        <div className='grid lg:grid-cols-3 gap-4 p-4'>
          ...
          <div className='lg:row-span-2  flex justify-between w-full  p-4 rounded-lg bg-gray-300 '>
