          ...
          {menBox.map((val, index) =>{  
            ...
            return(
              ...
              <NavLink
                ...
                className={`md:col-span-1 lg:col-span-1 cursor-pointer no-underline p-2 rounded-md shadow-md`}>
                    
                  <div  
                      className='grid lg:grid-cols-2 -mt-4 px-3 py-1 w-auto rounded-md text-marron bg-slate-300 hover:bg-light-white hover:text-black'>
