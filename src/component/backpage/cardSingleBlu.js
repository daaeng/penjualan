        ...
        <>
            <div className="">
                <div className="flex justify-end">
                    <div className=' bg-blue-600 sm:w-28 md:w-34 lg:w-72 p-3 rounded-tl-full relative sm:h-28 md:h-34 -mb-32'>
                    </div>
                ...
                <div className='grid sm:ml-2 sm:mr-2 sm:mb-2 sm:mt-1 sm:col-span-1 lg:grid-cols-2 md:ml-5 md:mr-5 md:mb-4 md:mt-3
                    ...
                    <div className='flex justify-end items-center'>
                        <div className='lg:row-span-2 md:-mt-0 sm:-mt-10 sm:ml-6 p-2 w-16 h-10 rounded-md -mt-4 bg-blue-600 flex justify-center hover:text-black text-white'>
                            {props.kananBru()}
                        </div>
                    </div>
